...
We can also import three-dimensional array from \pkg{NumPy} as the 
next example shows.
...
\pkg{RcppCNPy} remains an attractive option for simple, direct and lighter-weight 
file imports whereas \pkg{reticulate} by by \citet{CRAN:reticulate} shines a more
full-featured access to many more aspects of \proglang{Python}.
